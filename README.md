...
Необходимо реализовать React приложение "Modsen Travel" по предоставленному дизайну из Figma с использование state manager MobX. 
...
На данной странице в блоке “Popular Hotel” первоначально отображается список отелей в размере 16 элементов(для хранения данных используйте MobX). Также первоначально этот список должен отображаться на странице [Hotels](https://www.figma.com/file/mGx7G2IIwZR2CMzq28O3uq/Travel?type=design&node-id=1-9906&mode=design&t=LrVqiesnFhx4YlRt-0). 
...
- **_MobX_** - удобный state manager для хранения и управления состоянием; 
